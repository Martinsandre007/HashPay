...
export const afriexClient = {
    ...
    getInternationalBanks: async (region: 'Africa' | 'Europe') => {
        if (region === 'Europe') {
            return [
                { id: 'eur1', name: 'HSBC UK', country: 'United Kingdom', swift: 'HSBCGB2L' },
                { id: 'eur2', name: 'Deutsche Bank', country: 'Germany', swift: 'DEUTDEFF' },
                { id: 'eur3', name: 'BNP Paribas', country: 'France', swift: 'BNPAFRPP' },
                { id: 'eur4', name: 'Santander', country: 'Spain', swift: 'BSCHESSM' },
                { id: 'eur5', name: 'Revolut', country: 'Lithuania', swift: 'REVOVILT' }
            ];
        }
        return [
            { id: 'af1', name: 'Access Bank', country: 'Nigeria', code: '044' },
            { id: 'af2', name: 'GTBank', country: 'Nigeria', code: '058' },
            { id: 'af3', name: 'Zenith Bank', country: 'Nigeria', code: '057' },
            { id: 'af4', name: 'Kuda Bank', country: 'Nigeria', code: '090267' },
            { id: 'af5', name: 'EcoBank', country: 'Ghana', code: 'ECO' }
        ];
    },
    ...
    addAccount: async (details: any) => {
        ...
        return { success: true, message: 'Account created successfully', accountId: 'acc_' + Date.now() };
    },

    createSavingsGoal: async (goal: any) => {
        // Simulated Goal Creation
        await new Promise(resolve => setTimeout(resolve, 1000));
        return { success: true, message: 'Savings goal created successfully', goalId: 'goal_' + Date.now() };
    },
        ...
        // Simulated Card Issuance
         ...
         return {
             ...
             card: {
                 ...
                 status: 'Active',
                 number: '4321 **** **** ' + Math.floor(1000 + Math.random() * 9000),
                 expiry: '12/28',
                 cvv: '***'
             }
         };
