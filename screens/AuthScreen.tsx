...
const AuthScreen: React.FC<AuthScreenProps> = ({ onLogin }) => {
  ...
  const { login, register, registerSuiProfile, loginWithWallet, connectRealWallet } = useWallet();
      ...
      <div className="w-full max-w-md mx-auto px-8 flex-1">
        ...
        <div className="flex flex-col gap-4 pb-14">
          <button
            ...
            disabled={isConnectingWallet || isAuthenticating}
          ...
          >
            {isConnectingWallet || isAuthenticating ? (
              ...
              <>
                ...
                <span className="text-xs font-black uppercase tracking-widest text-black">Connect Wallet (MetaMask/Enkrypt)</span>
              </>
            )}
          </button>
          <button
