            ...
            <main className="w-full max-w-2xl bg-surface-dark/20 border border-white/5 rounded-[3rem] p-12 glass shadow-2xl">
                ...
                <div className="space-y-8">
                    ...
                    <button
                        ...
                        className={`w-full py-6 rounded-[2rem] font-black uppercase tracking-[0.4em] shadow-2xl transition-all active:scale-95 ${loading ? 'bg-gray-800' : (type === 'buy' ? 'bg-[#22c55e]' : 'bg-[#ef4444]')}`}
                    >
